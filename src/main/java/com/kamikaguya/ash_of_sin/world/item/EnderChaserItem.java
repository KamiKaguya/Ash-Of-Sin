...
public class EnderChaserItem extends WeaponItem{
    ...
    public EnderChaserItem(Item.Properties build) {
        ...
        if (AshOfSin.isPhysicalClient()) {
            ...
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".ender_chaser.tooltip.unique"));
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".ender_chaser.tooltip"));
        }
    }
