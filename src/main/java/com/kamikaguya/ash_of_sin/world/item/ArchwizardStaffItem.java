...
public class ArchwizardStaffItem extends WeaponItem{
    ...
    public ArchwizardStaffItem(Item.Properties build) {
        ...
        if (AshOfSin.isPhysicalClient()) {
            ...
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".archwizard_staff.tooltip.unique"));
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".archwizard_staff.tooltip"));
        }
    }
