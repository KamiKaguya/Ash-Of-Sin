...
public class MeltSwordItem extends WeaponItem {
    ...
    public MeltSwordItem(Item.Properties build) {
        ...
        if (AshOfSin.isPhysicalClient()) {
            ...
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".melt_sword.tooltip.unique"));
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".melt_sword.tooltip"));
        }
    }
