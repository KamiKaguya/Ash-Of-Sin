...
public class ElucidatorItem extends WeaponItem{
    ...
    public ElucidatorItem(Item.Properties build) {
        ...
        if (AshOfSin.isPhysicalClient()) {
            ...
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".elucidator.tooltip.unique"));
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".elucidator.tooltip"));
        }
    }
