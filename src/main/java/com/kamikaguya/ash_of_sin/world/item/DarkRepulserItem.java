...
public class DarkRepulserItem extends WeaponItem{
    ...
    public DarkRepulserItem(Item.Properties build) {
        ...
        if (AshOfSin.isPhysicalClient()) {
            ...
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".dark_repulser.tooltip.unique"));
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".dark_repulser.tooltip"));
        }
    }
