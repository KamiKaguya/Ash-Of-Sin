...
public class SculkAxeItem extends WeaponItem{
    ...
    public SculkAxeItem(Item.Properties build) {
        ...
        if (AshOfSin.isPhysicalClient()) {
            ...
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".sculk_axe.tooltip.sculk"));
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".sculk_axe.tooltip"));
        }
    }
