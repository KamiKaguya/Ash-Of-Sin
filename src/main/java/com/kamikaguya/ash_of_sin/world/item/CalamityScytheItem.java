...
public class CalamityScytheItem extends WeaponItem{
    ...
    public CalamityScytheItem(Item.Properties build) {
        ...
        if (AshOfSin.isPhysicalClient()) {
            ...
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".calamity_scythe.tooltip.unique"));
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".calamity_scythe.tooltip"));
        }
    }
