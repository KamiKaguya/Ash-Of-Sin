...
public class DarkMoonGreatswordItem extends WeaponItem{
    ...
    public DarkMoonGreatswordItem(Item.Properties build) {
        ...
        if (AshOfSin.isPhysicalClient()) {
            ...
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".dark_moon_greatsword.tooltip.unique"));
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".dark_moon_greatsword.tooltip"));
        }
    }
