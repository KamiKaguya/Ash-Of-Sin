...
public class DespairScytheItem extends WeaponItem{
    ...
    public DespairScytheItem(Item.Properties build) {
        ...
        if (AshOfSin.isPhysicalClient()) {
            ...
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".despair_scythe.tooltip.unique"));
            this.tooltipExpand.add(new TranslatableComponent("item." + AshOfSin.MODID + ".despair_scythe.tooltip"));
        }
    }
