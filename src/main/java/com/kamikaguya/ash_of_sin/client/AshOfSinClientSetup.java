...
public class AshOfSinClientSetup {
    ...
    public static void setupClient(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ItemProperties.register(AshOfSinItemRegistry.SUB_CRAVEN_BOW.get().asItem(), new ResourceLocation("pulling"), pulling);
            ItemProperties.register(AshOfSinItemRegistry.SUB_CRAVEN_BOW.get().asItem(), new ResourceLocation("pull"), pull);
        });
    }
}