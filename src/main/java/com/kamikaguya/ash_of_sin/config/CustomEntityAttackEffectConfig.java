    ...
    public void initializeDefaultConfig() {
        if (!Files.exists(configPath)) {
            List<CustomAttackEntityConfig> defaultCustomAttackEntityConfig = Arrays.asList(
                    new CustomAttackEntityConfig("minecraft:warden", List.of(
                            new CustomAttackEffectConfig("minecraft:darkness", 30, 2)
                    )),
                    new CustomAttackEntityConfig("minecraft:iron_glem", List.of(
                            new CustomAttackEffectConfig("minecraft:slowness", 30, 2)
                    ))
            );
