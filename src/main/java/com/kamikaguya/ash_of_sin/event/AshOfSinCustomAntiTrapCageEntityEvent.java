...
public class AshOfSinCustomAntiTrapCageEntityEvent {
    ...
    public static void breakTrapCageIfInDistance(Level world, LivingEntity entity) {
        ...
        for (BlockPos blockPos : BlockPos.betweenClosed(
                new BlockPos((int) entityBoundingBox.minX, (int) entityBoundingBox.minY, (int) entityBoundingBox.minZ),
                new BlockPos((int) entityBoundingBox.maxX, (int) entityBoundingBox.maxY, (int) entityBoundingBox.maxZ))) {
