    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        if (CustomAntiItemEntityConfig.ANTI_ON.get()) {
            ...
            if (antiItemEntityList.contains(entityResourceLocation.toString()) && source.getEntity() instanceof LivingEntity attacker) {
                ...
                ResourceLocation mainHandItemResLoc = ForgeRegistries.ITEMS.getKey(mainHandItem.getItem());
                ResourceLocation offHandItemResLoc = ForgeRegistries.ITEMS.getKey(offHandItem.getItem());
